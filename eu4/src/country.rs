...
pub struct Country {
    ...
    #[optional] pub colonial_parent: Eu4Atom,
    #[optional] pub fleet_names: Vec<String>,
    #[optional] pub historical_idea_groups: Vec<Eu4Atom>,
    #[optional] pub historical_score: i32,
    #[optional] pub historical_units: Vec<Eu4Atom>,
    #[optional] pub historical_council: Eu4Atom,
    #[optional] pub preferred_religion: Eu4Atom,
    ...
    #[optional] pub cannot_form_from_collapse_nation: bool,
}

...
pub struct CountryTradeNode {
    ...
    #[optional] pub _trading_strategy: String,
    #[optional] pub _trading_strategy_date: (), // XXX: Date
...
pub struct Country {
    ...
    #[optional] pub current_power_project: FixedPoint,
    ...
    #[optional] pub call_to_arms_friend: Vec<String>,

...
pub struct Province {
    #[optional] pub flags: HashMap<String, Date>,
    pub name: String,
    #[optional] pub territorial_core: String,
    #[optional] pub owner: String,
    #[optional] pub controller: String,
    #[optional] pub previous_controller: String,
    #[optional] pub original_coloniser: String,
    ...
    #[optional] pub cores: Vec<String>,
    #[optional] pub claims: Vec<String>,
    ...
    #[optional] pub last_razed_by: String,
    #[optional] pub hostile_core_creation_cost: FixedPoint,
    #[optional] pub hostile_core_creation_tag: String,
    ...
    #[optional] pub active_trade_company: String,

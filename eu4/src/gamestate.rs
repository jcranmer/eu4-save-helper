...
pub struct Gamestate {
    ...
    pub used_client_names: Vec<String>,
    pub speed: i32,
    ...
    #[repeated] pub saved_event_target: Vec<()>,
    ...
    pub dynamic_countries: Vec<CountryRef>,
    ...
    pub great_projects: HashMap<Eu4Atom, ()>,
    ...
    // meta file
    #[optional] pub date: Date,
    #[optional] pub save_game: String,
    #[optional] pub player: CountryRef,
    #[optional] pub displayed_country_name: String,
    #[optional] pub savegame_version: (),
    #[optional] pub savegame_versions: Vec<String>,
    #[optional] pub dlc_enabled: Vec<String>,
    #[optional] pub is_ironman: bool,
    #[optional] pub multi_player: bool,
    #[optional] pub not_observer: bool,
    #[optional] pub campaign_id: String,
    #[optional] pub campaign_length: i32,
    #[optional] pub campaign_stats: (),
...
pub struct Country {
    ...
    #[optional] pub treasure_fleet_gold: FixedPoint,
    #[optional] pub karma: FixedPoint,
    pub isolationism: i32,
    #[optional] pub last_month_treasure_fleet_gold: FixedPoint,
    ...
    #[optional] pub harmonized_religion_groups: Vec<i32>,
    ...
    #[optional] pub graphical_culture: Eu4Atom,
    ...
    #[optional] pub vital_provinces: Vec<i32>,
    ...
    #[optional] pub last_threatened: Date,
    ...
    #[optional] pub colonial_name_source: i32,
    ...
    #[optional] pub statists_vs_monarchists: FixedPoint,
    #[optional] pub last_sent_peace_offer_date: Date,
    #[optional] pub num_expanded_administration: i32,
    #[optional] pub expelled_different_minorities: Vec<()>,
    ...
    #[optional] pub tariff: FixedPoint,
    #[repeated] pub ancestor: Vec<()>,
    #[optional] pub client_parent: Eu4Atom,
}
...
pub struct Province {
    ...
    #[optional] pub exploit_date: Date,
    ...
    #[optional] pub great_projects: Vec<Eu4Atom>,
    #[optional] pub history: (),
    pub patrol: i32,
    ...
    #[optional] pub mothball_status: i32,
    ...
    #[optional] pub user_changed_name: bool,
    ...
    #[optional] pub great_project_construction: (),
    #[optional] pub num_centralize_state: i32,
    #[optional] pub variables: (),
    #[optional] pub change_culture_construction: (),
    #[optional] pub centralize_state_construction: (),
}
